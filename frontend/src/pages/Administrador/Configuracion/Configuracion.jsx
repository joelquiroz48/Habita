...
const tarjetasConfig = [
    {
        ...
        stats: [{ label: "Período actual", valor: "Mayo 2024" }, { label: "Día de vencimiento", valor: "10" }],
        boton: "Configurar",
        botonIcon: Settings,
    },
    {
        ...
        stats: [{ label: "Conceptos activos", valor: "12" }, { label: "Última actualización", valor: "02/05/2024" }],
    ...
    },
    {
        ...
        stats: [{ label: "Medios activos", valor: "4" }, { label: "Última actualización", valor: "15/04/2024" }],
    ...
    },
    {
        ...
        stats: [{ label: "Plantillas activas", valor: "8" }],
